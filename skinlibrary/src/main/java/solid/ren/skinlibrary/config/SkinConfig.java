...
public class SkinConfig {
    ...
    public static final String PRE_CUSTOM_SKIN_ID = "skin_custom_id";
    public static final String DEFAULT_SKIN_ID = "00";//默认皮肤id
     ...
     * @param skinId
     */
    public static void saveSkinId(Context context, String skinId) {
        SkinPreferencesUtils.putString(context, PRE_CUSTOM_SKIN_ID, skinId);
    }
    ...
    public static String getSkinId(Context context) {
        return SkinPreferencesUtils.getString(context, PRE_CUSTOM_SKIN_ID, DEFAULT_SKIN_ID);
    }
